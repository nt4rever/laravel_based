...
return [
    ...
    */
    ...
    'staff' => [
        ...
        'building_exits_user' => 'one of the buildings already exist user',
        'postal_code' => '郵便番号の形式が正しくありません。',
    ],

    //building
    'building' => [
        'incorect_formart_csv' => 'Incorect format csv',
        'file_format' => 'The file must be a file of type: csv, txt.',
